...
public class Gameplay extends JPanel implements ActionListener, KeyListener {
   ...
   */
  public Gameplay(int script, int tree, int difficulty) {
    ...
    GameTracker.setDifficulty(difficulty);
  }
  /**
  ...
  public void typeText() {
    ...
    this.add(person);
    addHealthBar();
    enemyTextObj = new Text(null,  25, 50,  false,  true,  false,  55,  15, enemyText, this);
    enemyTextObj.draw();
    int xPos;
  ...
  public void keyPressed(KeyEvent e) {
    if (isComplete() == true)
      ...
      if (keyValue == 87 || keyValue == 38) {
        ...
        if (!(playerText.equals(responses.get(correctResponse - 1))))
              GameTracker.makeHarder();
        this.removeKeyListener(this);
        typeText();
      }
    }
