...
public class TextDriverClass extends JFrame {
  ...
  public TextDriverClass () {
    ...
    Text t = new Text (new Color (25,25,25,0),  40,40,  false,  false,  true,  50,  20, "TEST", panel);  
    Text t2 = new Text (new Color (25,25,25,0),  40,80,  true,  false,  false,  20,  100, "PEEPEE", panel);  
